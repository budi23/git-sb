        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url('tampil-data-karyawan-nonaktif') ?>">Data Nonactive karyawan</a></li>
            ...
            <!-- /.card-header -->
              ...
              <div id="form_telp">
                ...
                <?php
                  ...
                  if($user->tgl_keluar == ''){
                    $tgl_keluar = html_escape($user->tgl_keluar);
                  }else{
                    $tgl_keluar = date('d-F-Y', strtotime(html_escape($user->tgl_keluar)));
                  }
                 ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="tgl_keluar" value="<?php echo $tgl_keluar ?>" disabled>
                </div>
                <?php endif ?>
