        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><?php echo $company->company_name ?></li>
        ...
        <div class="col-md-8">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Insert Customer <?php echo $company->company_name ?></h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?php echo base_url('proccesing-insert-customer') ?>" method="post">
              <div class="card-body">
                <div class="form-group">
                  <label for="company_name">Company Name</label>
                  <input type="hidden" name="id_company" value="<?php echo $company->id_company ?>">
                  <input type="text" class="form-control" name="company_name" placeholder="Company Name" value="<?php echo $company->company_name ?>" readonly>
                </div>
                <div class="form-group">
                  <label for="company_name">Customer Name</label>
                  <input type="text" class="form-control" name="customer_name" placeholder="Customer Name" value="<?php echo set_value('customer_name') ?>" >
                </div>
                ...
                <div id="form_telp">
                  <div class="form-group" id="dtelp1">
                    ...
                    <div class="input-group">
                      ...
                      <input id="telp1" type="text" name="telp[]" class="form-control insert-tlp" value="<?php echo set_value('telp[]') ?>" maxlength="17" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="whatsapp" class="form-control" value="<?php echo set_value('whatsapp') ?>" maxlength="17">
                    </div>
                    <!-- /.input group -->
                  </div>
                <div class="form-group">
                  <label for="email">Email address <mark class="text-gray">&lt;Optional&gt;</mark></label>
                  <input id="email_" type="email" class="form-control" name="email" placeholder="Email Address Customer" >
                ...
                <div class="form-group">
                  <label>Note</label>
                    <textarea class="form-control" name="note" rows="3" placeholder="Write A Note About Customer" required><?php echo set_value('note') ?></textarea>
                </div>
...
<script>
  ...
  $(function () {
    ...
    $('#add_telp').click(function(event) {
      ...
      $n++;
      $('#form_telp').append(
        "<div class='form-group' id='dtelp"+$n+"'><div class='input-group'><div class='input-group-prepend'><span class='input-group-text'><i class='fas fa-phone'></i></span></div><input id='telp"+$n+"' type='text' name='telp[]' class='form-control insert-telp' required><span class='input-group-append'><button type='button' class='btn btn-danger btn-flat' data-delete= 'dtelp"+$n+"'><i class='fas fa-plus-min'></i>Hapus</button></span></div></div>"
        );
      // cek_ulang_telp()
    });
