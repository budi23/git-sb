        ...
        <div class="col-md-8">
          ...
          <div class="card card-info">
            <div class="card-header">
              <h3 class="card-title">Edit Company [ <?php echo trim($company->company_name) ?> ]</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?php echo base_url('proccesing-update-company') ?>" method="post">
              <div class="card-body">
                <div class="form-group">
                  <input type="hidden" name="id_company" value="<?php echo trim($company->id_company) ?>">
                  <label for="id">Company Name</label>
                  <input type="text" class="form-control" name="company_name" placeholder="Company Name" value="<?php echo trim($company->company_name) ?>" required>
                </div>
                <!-- textarea -->
                <div class="form-group">
                  <label>Address</label>
                    <textarea class="form-control" name="address_company" rows="3" placeholder="Address Company" required><?php echo trim($company->address) ?></textarea>
                </div>
                <div class="form-group">
                  <label for="tempatlahir">Phone</label>
                  <input type="text" class="form-control" name="phone_company" placeholder="Phone Number Company" value="<?php echo $company->phone ?>" >
                </div>
                <div class="form-group">
                  <label for="email">Email address <mark class="text-gray">&lt;Optional&gt;</mark></label>
                  <input id="email_" type="email" class="form-control" name="email_company" placeholder="Email Address Company" value="<?php echo $company->email ?>" ?>
