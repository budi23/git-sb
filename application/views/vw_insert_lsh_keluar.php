        ...
        <div class="col-md-8">
          ...
          <div class="card card-danger">
            <div class="card-header">
              <h3 class="card-title">LSH Barang Keluar</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?php echo base_url('processing-insert-lsh/keluar') ?>" method="post" enctype='application/x-www-form-urlencoded'>
              <!-- popup insert date -->
              <div id="dtBox"></div>
              <!-- end popup -->
              <div class="card-body">
                <div class="form-group">
                  <label for="tgl_lsh">Tanggal Keluar</label>
                ...
                <!-- select company-->
                <div class="form-group">
                  <label>Pilih Customer <mark class="text-gray">&lt; Optional &gt;</mark></label>
                  <select id="select_company" name="company" class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" >
                    <option value="">--Pilih Customer--</option>
                    <?php 
                      $val_cmp = set_value('company');
                      $val_nbarang = set_value('id_barang');
                      $val_penerima = set_value('penerima');
                    ?>
                    <?php foreach ($company as $cmp) :?>
                      <?php if(trim($cmp->id_company) == $val_cmp){ ?>
                        <option value="<?php echo $cmp->id_company ?>" selected='selected'><?php echo $cmp->company_name ?></option>
                      <?php }else{ ?>
                ...
                <div class="form-group">
                  ...
                  <select id="select_barang" name="id_barang" data-value="<?php echo set_value('id_barang') ?>" class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" required>
                ...
                <div class="form-group">
                  ...
                  <select id="select_penerima" name="penerima" data-value="<?php echo set_value('penerima') ?>" class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;" required>
                ...
                <div class="form-group">
                  ...
                  <input id="saldo" type="text" class="form-control" name="saldo" data-saldo="0" placeholder="Masukkan Jumlah Saldo" value="<?php echo set_value('saldo') ?>" required readonly>
                </div>
...
<script>
  ...
  $(function () {
    ...
    var error_tgl = "<?php echo $this->session->flashdata('tgl_keluar'); ?>";
    var errot_stock = "<?php echo $this->session->flashdata('stock'); ?>";
