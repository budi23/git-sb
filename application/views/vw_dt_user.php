  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>Data User Account ( <?php echo $ttl_user ?> )</h3>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data User Account</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      <button data-id="<?php echo $data->id ?>" type="button" class="btn btn-default btn-skill">View</button>
                      <button data-id="<?php echo $data->id ?>" type="button" class="btn btn-default btn-edit" name="edit"><i class="far fa-edit"></i>Edit</button>
                    </div>
                  </td>
                </tr>
                <?php endforeach; ?>
