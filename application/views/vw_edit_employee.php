        ...
        <div class="col-md-8">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Data Karyawan [ <?php echo $user->nama ?> ]</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?php echo base_url("proccesing-update-data") ?>" method="post">
              <div class="card-body">
                <div class="form-group">
                  <label for="id">No Induk</label>
                  <input type="text" class="form-control" name="no_induk2" value="<?php echo html_escape(trim($user->no_induk)) ?>" disabled>
                  <input type="hidden" name="no_induk" value="<?php echo html_escape(trim($user->no_induk)) ?>">
                </div>
                <div class="form-group">
                  <label for="nama">Nama</label>
                  <input type="text" class="form-control" name="nama" value="<?php echo html_escape(trim($user->nama)) ?>" required>
                </div>
                <div class="form-group">
                  <label for="tempatlahir">Tempat Lahir</label>
                  <input type="text" class="form-control" name="tempat_lahir" placeholder="Masukkan Tempat Lahir" value="<?php echo html_escape(trim($user->tempat_lahir)) ?>" required>
                </div>
                <!-- Date dd/mm/yyyy -->
                <?php 
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input data-field="date" name="tgl_lahir" class="form-control" value="<?php echo $tgl_lahir ?>" required>
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- select -->
                <div class="form-group">
                  ...
                  <select id="gender" class="custom-select" name="jkelamin" data-value="<?php echo html_escape(trim($user->gender)) ?>" required>
                ...
                <div class="form-group">
                  <label>Alamat Tinggal ( Surabaya )</label>
                    <textarea class="form-control" name="alamat_tinggal" rows="3" ><?php echo html_escape($user->alamat_tinggal) ?></textarea>
                </div>
                <!-- textarea -->
                <div class="form-group">
                  <label>Alamat Rumah</label>
                    <textarea class="form-control" name="alamat_rumah" rows="3"><?php echo html_escape($user->alamat_rumah) ?></textarea>
                </div>
              ...
              <div id="form_telp">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input id="whatsapp" type="text" name="whatsapp" class="form-control" value="<?php echo html_escape(trim($user->whatsapp)) ?>" data-inputmask='"mask": "999-999-999-999"' data-mask>
                  </div>
                  <span id="wa_valid" class="d-none" style="color: #FF0000">*Format Whatsapp tidak sesuai</span>
                  <!-- /.input group -->
                </div>

                <div class="form-group">
                  <label for="email">Email address</label>
                  <input id="email_" type="email" class="form-control" name="email" placeholder="Masukkan email" value="<?php echo html_escape($user->email) ?>">
                  <span id="emailvalid_" class="d-none" style="color: #FF0000">*Format Email tidak sesuai</span>
                </div>

                <?php 
                  $originalDate = html_escape($user->tgl_masuk);
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input id="tgl_masuk" data-field="date" name="tgl_masuk" class="form-control" value="<?php echo $tgl_masuk ?>" required>
                  </div>
                  <!-- /.input group -->
                </div>
                ...
                <!-- <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input id="tgl_keluar" data-field="date" name="tgl_keluar" class="form-control" value="<?php echo html_escape($user->tgl_keluar) ?>">
                  </div> -->
                  <!-- /.input group -->
                <!-- </div> -->
              <!-- /.card-body -->
...
<script>
  ...
  $(function () {
    ...
    $('#tgl_keluar').on('keyup', function(event) {
      $(this).val('');
    });
    ...
    $('#tgl_keluar').attr('data-min', tgl_masuk);
